def create_prompt_from_desc(product_name, product_desc, customer_name, customer_desc):
    ...
    prompt1 = "Generate a short creative and personalised text advertisement with emojis for product -  Coding Ninjas DSA Course,  with product description - Data Structures and Algorithms in Java for begineers and newbies. Customer Name - Siddhesh , Customer Interest -  Watching Cricket"
    return prompt1
